...
parser.add_argument( "--encoder2",           choices=['none', 'class','colorize','otsu'], default='otsu')
...
parser.add_argument( "--pretrain-enc-name2",  type=str, default='erfnet_encoder.pth')
parser.add_argument( "--name",           type=str, default='erfnet_exp4wotsu.pth')
