...
SAVE_PATH = ROOT_PATH + '/Documents/Quad-S-Learning/save/relPatch/'

parser = argparse.ArgumentParser()
parser.add_argument( "--resume", action='store_true')
parser.add_argument( "--premode",           choices=['none', 'imagenet'], default='none')
...
parser.add_argument( "--savename",  type=str, default='erfnet_relpatch_citywaug.pth')
...
def main():
    ...
    model = ERFNet_relpatch(num_classes=8,encoder=pretrainedEnc).cuda()
